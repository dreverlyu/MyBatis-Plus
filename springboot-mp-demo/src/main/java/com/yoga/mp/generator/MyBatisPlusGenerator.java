...
//				.setUrl("jdbc:mysql://218.29.75.103:6306/shanjupay_merchant_service?serverTimezone=Asia/Shanghai");
        ...
        //PGSQL配置数据库名字
//		dataSourceConfig
//				.setUrl("jdbc:mysql://127.0.0.1:3306/shanjupay_merchant_service?serverTimezone=Asia/Shanghai&useSSL=false");
//				.setUrl("jdbc:postgresql://localhost:5432/postgres?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&useSSL=false");
...
//		autoGenerator.setDataSource(dataSourceConfig);
        ...
        dataSourceConfig.setUsername("system");
        dataSourceConfig.setPassword("root");
        autoGenerator.setDataSource(dataSourceConfig);

        // 生成包配置
        PackageConfig packageConfig = new PackageConfig();
//        packageConfig.setParent("com.yoga.mp.geneCode");
        packageConfig.setParent("com.fleetup");
        //如果需要手动输入模块名
